...
$site->pageStart(array('popfit'=>1));
	...
	$site->skin->submenuStart();
		echo '<h2>&#9776;</h2> <b>Men�-Cache l�schen f�r Portal "'.$kurzname.'"</b>';
...
?>
		...
		<form action="<?php echo $_SERVER['PHP_SELF']."?module=".$_GET['module']."&menucache=delete&id=".$portal_id; ?>" method="POST">
			<p>Den Cache f�r Men&uuml;s zu l&ouml;schen sorgt daf&uuml;r, dass bisherige &Auml;nderungen an Men&uuml;s in Portaleinstellungen sofort aktuell auf der Website zur Verf&uuml;gung stehen.</p>
			<br>
			<input type="submit" value="Men�-Cache jetzt l�schen">
			<br><br><br>
		</form>
	...
	$site->skin->submenuStart();
		echo '<h2>&#128270;</h2> <b>Such-Cache l�schen f�r Portal "'.$kurzname.'"</b>';
	$site->skin->submenuBreak();
		echo "&nbsp;";
	$site->skin->submenuEnd();
	...
	$site->skin->buttonsStart();
		form_button('cancel', 'Fenster schlie�en.', 'window.close();return false;');
