...
class KI_ADMIN_UTIL
{
	public static function selectPortalOrFwd301($db)
{
...
public static function explodeSettings__($in, &$out, $follow_includes)
{
	$in = strtr($in, "\r\t", "\n ");
	$in = explode("\n", $in);
...
public static function explodeSettings($in)
{
	$out = array();
	KI_ADMIN_UTIL::explodeSettings__($in, $out, true);
	return $out;
}
}